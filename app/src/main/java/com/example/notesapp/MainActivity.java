...
public class MainActivity extends AppCompatActivity {
    ...
    public static final int EditdNoteRequest = 2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                Toast.makeText(MainActivity.this, "Text Deleted", Toast.LENGTH_LONG).show();
            }
        ...
        adapter.setonitemclicklistener(new NoteAdapter.onitemclicklistener() {
            ...
            public void onitemclick(Note note) {
                ...
                startActivityForResult(intent, EditdNoteRequest);
            }
        });
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        } else if (requestCode == AddNoteRequest && resultCode == RESULT_OK) {
